  ...
  return (
    <div className="rounded-3xl border border-slate-700/80 bg-slate-950/80 p-6 shadow-xl shadow-slate-950/20">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <button className="rounded-3xl border border-amber-500/20 bg-amber-500/5 px-5 py-4 text-left text-sm font-semibold text-amber-300 transition hover:border-amber-400 hover:bg-amber-500/10">
        ...
        <button className="rounded-3xl border border-emerald-500/20 bg-emerald-500/5 px-5 py-4 text-left text-sm font-semibold text-emerald-300 transition hover:border-emerald-400 hover:bg-emerald-500/10">
