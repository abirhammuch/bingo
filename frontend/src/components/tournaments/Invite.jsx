  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#030b25] px-3 pb-10 pt-4 text-slate-100 sm:px-5 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-4 flex flex-col mb-10 items-center justify-between gap-4 rounded-xl border border-violet-700/70 bg-gradient-to-r from-[#111266] to-[#1f0d63] px-5 py-4 sm:flex-row sm:px-8">
